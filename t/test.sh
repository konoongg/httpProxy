...
curl -o results/m_result-1 --http1.0 --progress-bar  --proxy1.0 localhost:8080  http://xcal1.vodafone.co.uk/
curl -o results/m_result-2 --http1.0 --progress-bar  --proxy1.0 localhost:8080  http://gramota.ru/
